...
class MultiLoraVLLMRollout(BaseRollout):
    def __init__(
        self,
        config: RolloutConfig,
        model_config: HFModelConfig,
        device_mesh: DeviceMesh,
        tasks_config: Dict # task_id -> task config
    ):
        ...
        num_tasks = len(self.tasks_config)
        max_lora_rank = max([task_config.actor_rollout_ref.model.lora_rank for task_config in tasks_config.values()])
        self.lora_kwargs = (
